...
public class PropertyMgmDriverNoGui {
	...
	public static void main(String[] args) {
		...
		Plot square = new Plot(0,0,2,2);
		Plot square2 = new Plot(0,0,2,2);
		Plot square5 = new Plot(2,0,1,2);
		
		Plot square3 = new Plot(3,3,3,3);
		Plot square4 = new Plot(4,4,1,1);
		
		System.out.print(square.Overlaps(square2)); //true
		System.out.print(square.Overlaps(square3)); //false
		System.out.print(square3.Encompasses(square4)); //true
		System.out.print(square.Overlaps(square5)); //false
